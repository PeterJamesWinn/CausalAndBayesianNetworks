...
data_array = add_noise_to_data_sd_data_scaled(scanned_data_list, standard_deviation_scale)
data_array = np.concatenate([data_array, 
    add_noise_to_data_sd_data_scaled(scanned_data_list, standard_deviation_scale)], axis = 0 )
data_array = np.concatenate([data_array, 
    add_noise_to_data_sd_data_scaled(scanned_data_list, standard_deviation_scale)], axis = 0 )
